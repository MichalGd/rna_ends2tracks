...
DEFAULT_RESOURCES: dict[str, Any] = {
    ...
    "apa_b": {
        "engine_threads": 8,
        "engine_memory_gb": 24,
        "endpoint_parallel_jobs": 8,
        "cluster_parallel_jobs": 8,
        "deepip_threads": 8,
        "sample_memory_gb": 4,
        "contrast_parallel_jobs": 1,
        "contrast_threads": 1,
...
def resource_plan_rows(resources: dict[str, Any], counts: dict[str, int] | None = None) -> list[dict[str, Any]]:
    ...
    definitions = [
        ...
        ("apa_b", "polyaseqtrap_cluster", "external_process", counts.get("samples", 0),
         apa_b["cluster_parallel_jobs"], 1, apa_b["sample_memory_gb"]),
        ("apa_b", "deepip", "external_process", 1, 1,
         apa_b["deepip_threads"], apa_b["engine_memory_gb"]),
